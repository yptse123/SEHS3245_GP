    ...
    <!-- jQuery -->
    <script src="https://sleipnir.shop/js/jquery-1.12.4.min.js"></script>
    <script src="https://sleipnir.shop/js/jquery-ui.min.js"></script>

    <!-- Bootstrap -->
    <script src="https://sleipnir.shop/js/bootstrap.min.js"></script>

    <!-- Slider JS -->
    <script src="https://sleipnir.shop/js/owl.carousel.min.js"></script>
